...
import { loadRunFailuresPage } from '../../../../lib/serverGraphql.js';
...
export default async function handler(req, res) {
  ...
  try {
    const data = await loadRunFailuresPage({
    ...
    return sendUnexpectedApiError(res, error, trace.requestId, 'Unable to load run failures.');
  }
}
