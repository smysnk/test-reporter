...
import { loadRunInsights } from '../../../../lib/serverGraphql.js';
...
export default async function handler(req, res) {
  ...
  try {
    const data = await loadRunInsights({
      session,
    ...
    return sendUnexpectedApiError(res, error, requestTrace.requestId, 'Unable to load run insights.');
  }
}
