...
export function WebShell({ children, viewer = null, session = null }) {
  ...
  return React.createElement(
    'div',
    { className: 'web-shell web-shell--operations' },
    React.createElement(
      'header',
      ...
      React.createElement(
        'div',
        null,
        React.createElement('p', { className: 'web-shell__eyebrow' }, 'TS'),
        React.createElement('h1', { className: 'web-shell__title' }, 'Test Station'),
      ),
      React.createElement(
        'div',
