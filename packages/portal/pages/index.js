  ...
  return React.createElement(
    ...
    React.createElement(
      SectionCard,
      {
        ...
        copy: 'The portal now opens on a live operator dashboard: accessible projects, recent executions, and the latest coverage signal in one place.',
      },
          ...
          ? React.createElement(
            ...
            ...projects.map((project) => React.createElement(
              ...
              React.createElement(
                ...
                React.createElement('strong', { className: 'portal-list__title' }, project.name),
                React.createElement('span', { className: 'portal-chip' }, project.key),
              ),
              React.createElement(
                'div',
          ...
          ? React.createElement(
            ...
            ...runs.map((run) => React.createElement(
              ...
              React.createElement(
                'div',
                { className: 'portal-list__row' },
                React.createElement('strong', { className: 'portal-list__title' }, run.project?.name || run.externalKey),
