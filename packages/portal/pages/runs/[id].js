...
import { EmptyState, InlineList, MetricGrid, SectionCard, StatusPill } from '../../components/PortalBits.js';
      ...
      React.createElement(
        ...
        coverageComparison
          ...
          : React.createElement(EmptyState, {
            ...
            copy: 'A previous run is required before the portal can compute a coverage delta.',
          }),
      ),
      React.createElement(
        SectionCard,
        ...
        runPackages.length > 0
          ? React.createElement(
            ...
            ...runPackages.map((pkg) => React.createElement(
              'article',
              { className: 'portal-list__item', key: pkg.name },
              React.createElement(
                'div',
                { className: 'portal-list__row' },
                React.createElement('strong', { className: 'portal-list__title' }, pkg.name),
                React.createElement(StatusPill, { status: pkg.status }),
              ),
              React.createElement(
                'div',
                { className: 'portal-list__row' },
                React.createElement('span', { className: 'portal-chip' }, `${pkg.suiteCount} suites`),
                React.createElement('span', { className: 'portal-chip' }, formatDuration(pkg.durationMs)),
              ),
        ...
        Array.isArray(run.artifacts) && run.artifacts.length > 0
          ? React.createElement(
            ...
            ...run.artifacts.map((artifact) => React.createElement(
              'article',
              { className: 'portal-list__item', key: artifact.id },
              React.createElement(
                'div',
                { className: 'portal-list__row' },
                React.createElement('strong', { className: 'portal-list__title' }, artifact.label || artifact.relativePath || artifact.href || artifact.id),
                React.createElement('span', { className: 'portal-chip' }, artifact.kind),
              ),
              artifact.href
                ? React.createElement('a', { href: artifact.href, target: '_blank', rel: 'noreferrer' }, artifact.href)
                : React.createElement('span', { className: 'portal-list__meta' }, artifact.relativePath || 'No public href'),
            )),
          )
          : React.createElement(EmptyState, {
        ...
        failedTests.length > 0
          ? React.createElement(
            ...
            ...failedTests.map((test) => React.createElement(
              'article',
              { className: 'portal-list__item', key: test.id },
              React.createElement(
                'div',
                { className: 'portal-list__row' },
                React.createElement('strong', { className: 'portal-list__title' }, test.fullName),
              ...
              test.failureMessages?.length
                ? React.createElement(
                  ...
                  ...test.failureMessages.map((message, index) => React.createElement('span', { className: 'portal-chip', key: `${test.id}-${index}` }, message)),
                )
                : null,
            )),
          )
          ...
          runModules.length > 0
            ? React.createElement(
              ...
              ...runModules.slice(0, 4).map((moduleEntry) => React.createElement(
                'article',
                { className: 'portal-list__item', key: moduleEntry.module },
                React.createElement(
                  'div',
                  { className: 'portal-list__row' },
                  React.createElement('strong', { className: 'portal-list__title' }, moduleEntry.module),
                  React.createElement('span', { className: 'portal-chip' }, formatCoveragePct(moduleEntry.coverage?.lines?.pct)),
                ),
                React.createElement('div', { className: 'portal-list__meta' }, `${moduleEntry.owner || 'unowned'} • ${moduleEntry.packageCount} packages`),
      ...
      Array.isArray(run.suites) && run.suites.length > 0
        ? React.createElement(
          ...
          ...run.suites.map((suite) => React.createElement(
            'article',
            { className: 'portal-list__item', key: suite.id },
            React.createElement(
              'div',
              { className: 'portal-list__row' },
              React.createElement('strong', { className: 'portal-list__title' }, suite.label),
              React.createElement(StatusPill, { status: suite.status }),
            ),
            React.createElement(
              'div',
              { className: 'portal-list__row' },
              React.createElement('span', { className: 'portal-chip' }, suite.runtime),
              React.createElement('span', { className: 'portal-chip' }, formatDuration(suite.durationMs)),
              React.createElement('span', { className: 'portal-chip' }, `${suite.tests.length} tests`),
            ),
...
function ChangeListCard({ title, changes }) {
  return React.createElement(
    'div',
    { className: 'portal-card portal-card--compact' },
    React.createElement('p', { className: 'portal-card__eyebrow' }, title),
    Array.isArray(changes) && changes.length > 0
      ? React.createElement(
        ...
        ...changes.map((change) => React.createElement(
          'article',
          { className: 'portal-list__item', key: `${change.scopeType}:${change.label}` },
          React.createElement(
            'div',
            { className: 'portal-list__row' },
            React.createElement('strong', { className: 'portal-list__title' }, change.label),
            React.createElement('span', { className: 'portal-chip' }, formatSignedDelta(change.deltaLinesPct)),
          ),
          React.createElement(
            'div',
            { className: 'portal-list__meta' },
